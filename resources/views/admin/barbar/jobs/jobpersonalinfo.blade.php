...
<div class="container-fluid">
    <div class="row">
    <form action="{{route('storepersonalinfo')}}" method="POST">
            @csrf
            <div class="row py-4">
              ...
              <div class="row">
                  ...
                  <div class="mb-3 col-md-6">
                      ...
                      <input class="form-control" type="text" name="gateno" />
                  </div>
                </div>
                <div class="row">
                  <div class="mb-3 col-md-6">
              ...
              <div class="row">
                  <div class="mb-3 col-md-6">
                      ...
                      <select name="experiencebarber" class="form-control" id="">
              ...
              <div class="mb-3 col-md-6">
                      ...
                      <input class="form-control" type="text"
                          name="previewsalonname" autofocus />
                  </div>
                  <div class="mb-3 col-md-6">
                      <label for="presalonaddress" class="form-label">Previeus Salon Address</label>
                      <input class="form-control" type="text" name="presalonaddress" />
                  </div>
              ...
              <div class="row">
                  <div class="mb-3 col-md-6">
                      ...
                      <input class="form-control" type="text" name="position_role" />
                  </div>
                  <div class="mb-3 col-md-6">
                      <label for="reasonforleaving" class="form-label">Reason For Leaving</label>
                      <input class="form-control" type="text"
                          name="reasonforleaving" autofocus />
                  </div>
              </div>  
              <div class="row py-4">
              ...
              <div class="row">
                  <div class="mb-3 col-md-6">
                      ...
                      <input class="form-control" type="text" name="barber_licence_no" />
                  </div>
                  <div class="mb-3 col-md-6">
                      <label for="institute_name" class="form-label">Institute / Organization Name</label>
                      <input class="form-control" type="text"
                          name="institute_name" autofocus />
                  </div>
              </div>  
              ...
              <div class="row">
                  <div class="mb-3 col-md-6">
                      ...
                      <input class="form-control" type="text" name="institute_address" />
                  </div>
                  <div class="mb-3 col-md-6">
                      <label for="certificate_training" class="form-label">Certificate/Training Name</label>
                      <input class="form-control" type="text"
                          name="certificate_training" autofocus />
                  </div>
              </div>  
