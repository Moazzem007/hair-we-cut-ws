                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-title">
                        ...
                        <div class="ibox-content">
                            ...
                            <form action="{{ route('barberproducts.store') }}" method="POST" role="form" id="form">
                                {{ csrf_field() }}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="barber" id="" class="form-control">
                                                ...
                                                @foreach ($barbers as $barber)
                                                    <option value="{{ $barber->user_id }}">{{ $barber->name }} /
                                                        {{ $barber->salon }} </option>
                                                @endforeach
                                            </select>
                                        </div>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    data.forEach(element => {
                        html += '<option value="' + element.id + '">' + element.product_name +
                            '</option>'
                    });
