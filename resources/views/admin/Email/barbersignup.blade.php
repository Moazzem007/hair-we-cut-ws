                                ...
                                <table cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td class="content-block">
                                            Dear partner your business account has been created on Hair we cut. Details
                                            of your profile are <br>
                                            <strong>{{ $data['shop'] }}</strong>, Address
                                            <strong>{{ $data['address'] }}</strong>, Email
                                            <strong>{{ $data['email'] }}</strong> & contact Number
                                            <strong>{{ $data['contact'] }}</strong> .
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="content-block">
                                            The login credentials for using the business account are <br>
                                            ...
                                            @endif
                                            Url : www.hairwecut.co.uk/portal
                                            <br>
                                            <br>
