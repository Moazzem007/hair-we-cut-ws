                                ...
                                <table cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td class="content-block">
                                            Dear Partner, you have received a new appointment request. Here are the details:
                                            <br><br>
                                            Customer: <strong>{{ $data['name'] }} {{ $data['last_name'] }}</strong> <br>
                                    ...
                                    <tr>
                                        <td class="content-block">
                                            Please log in to your account to accept or manage this appointment.
                                            <br>
