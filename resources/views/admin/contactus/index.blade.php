                            ...
                            <tbody>
                                @foreach($contacts as $key => $contact)
                                    <tr>
                                        ...
                                        <!-- <td>
                                            <div class="btn-group">
                                                {{-- <a href="{{route('contact.edit',$contact->id)}}" class="btn btn-xs btn-outline btn-warning"><i class="fa fa-edit"></i> Edit</a> --}}
                                                <a href="{{route('servicesDelete',$contact->id)}}" class="btn btn-xs btn-outline btn-danger"><i class="fa fa-trash"></i> Delete</a>
                                            </div>
                                        </td> -->
                                    </tr>
                                @endforeach
                                ...
                                {{ csrf_field() }}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label>Title</label> 
                                                <input type="text" placeholder="Enter Service Title" name="title" class="form-control">
                                            </div>
                                        </div>
