    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
               ...
               <a href="" class="btn btn-primary ml-auto" data-toggle="modal" data-target="#modal-form" style="float: right;">Add Image</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <a href="{{ route('deleteonboardinghome', $item->id) }}"
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-10 col-md-offset-1">
                            ...
                            <form action="{{ route('storeonboarding_home_image')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                    <div class="row">

                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label>Home Screen Image</label>
