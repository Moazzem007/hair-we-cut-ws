...
<head>
    ...
    <style>
        body{
            background:url('{{asset("portfolio-1.jpg")}}');
    ...
    <div class="loginColumns animated fadeInDown">
        <div class="row" style="background:rgba(255,255,255,0.7);padding:20px;">
            ...
            <div class="col-md-6 text-center">
                <img class="wow fadeInUp" data-wow-delay="500ms" src="{{asset('logo.png')}}" alt="logo" width="100">
                ...
                <div class="ibox-content">
                    <form action="{{ route('login') }}" method="POST">
                        ...
                        <!-- <a class="btn btn-primary block full-width m-b" href="{{route('outsidemarket')}}" style="background-color:rgb(168, 151, 136);"
            role="button">
            Market Place
          </a>
          <a class="btn btn-primary block full-width m-b" href="#!" style="background-color:rgb(168, 151, 136);"
            role="button">
            Job Portal</a> -->
